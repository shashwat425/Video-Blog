import {
  Box, Flex, Grid, GridItem, Slider, SliderFilledTrack, SliderThumb, SliderTrack, Text, useColorModeValue, Image, Popover, PopoverTrigger, 
  Button, PopoverContent, PopoverCloseButton, PopoverHeader, PopoverBody, PopoverArrow, PopoverFooter, ButtonGroup, useBreakpointValue
...
const VideoPinDetail = () => {
  ...
  // let breakpointValue1 = useBreakpointValue({sm : 12, md: 12, lg: 8});
  // let breakpointValue2 = useBreakpointValue({sm : 12, md: 12, lg: 2});
  ...
  return (
    <Flex width={"full"} height="auto" justifyContent={"center"} alignItems="center" direction={"column"} py={2} px={4}>
      <Flex alignItems={"center"} width="full" my={4}>
        ...
        <Text isTruncated color={textColor} fontWeight="semibold" width={"100%"} >
          {videoInfo?.title}
        </Text>
      </Flex>
      ...
      <Grid templateColumns="repeat(4, 1fr)" gap={2} width="100%">
        {/* <GridItem colSpan={breakpointValue1}> */}
              ...
              >
                ...
                <Flex width={"full"} alignItems="center" my={2} gap={10}>
                  ...
                  <Box onClick={() => setIsPlaying(!isPlaying)}>
                    {!isPlaying ? (
                      <IoPlay fontScolor="#f2f2f2" cursor={"pointer"} />
                    ) : (
                  ...
                  <Flex alignItems={"center"}>
                    ...
                    min={0} max={100} size="sm" width={16} mx={2} 
                    onChangeStart={onvolumechange} onChangeEnd={onvolumechange} >
                      <SliderTrack bg="teal.50">
                        <SliderFilledTrack bg="teal.300" />
                      </SliderTrack>
        ...
        {/* <GridItem colSpan={breakpointValue2}> */}
            ...
            <Flex direction={"column"} width={"full"}>
              <Flex alignItems={"center"} width="full">
                <Image
                  ...
                  rounded="full" width={"60px"} height={"60px"} minHeight="60px" minWidth={"60px"}/>
      ...
      {feeds && (
        <Flex direction={"column"} width="full" my={6}>
          ...
          { feeds.length == 0 ? '' : 'Recommended Videos' }
          </Text>
