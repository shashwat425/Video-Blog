...
export const getAllFeeds = async (firestoreDb) => {
  ...
  //fetch data from firebase as a collection and order by id in desc oreder

  return feeds.docs.map((doc) => doc.data());
//fetching doc one by one and inside the doc fetching each field 
//one by one using data method
};
